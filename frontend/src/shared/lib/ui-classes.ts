...
export const surfaces = {
  card:
    "rounded-[var(--radius-2xl)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-card)]",
  cardInteractive:
    "rounded-[var(--radius-2xl)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-card)] transition-[box-shadow,transform,border-color] duration-[var(--transition-base)] hover:-translate-y-1 hover:border-[var(--color-border-strong)] hover:shadow-[var(--shadow-card-hover)] motion-reduce:transform-none motion-reduce:transition-none",
  pill:
